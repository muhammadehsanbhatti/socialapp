...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @can('user-change-password')
                            <a class="dropdown-item" href="{{ url('change_pass')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 mr-50">
                                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                </svg>
    ...
    @elseif (preg_match('/\bprofessional_role_type\b/', Request::path() ))
        <!-- Professional Role Script -->
        <script src="{{ asset('js/professional_role.js') }}"></script>
    @elseif (preg_match('/\bindustry_vertical_item\b/', Request::path() ))
        <!-- Industry vertical Script -->
        <script src="{{ asset('js/industry_verticals.js') }}"></script>
