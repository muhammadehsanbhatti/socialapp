@section('title', 'Professional Role List')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Filter Professional Role</h4>
                        </div>
                        
                        <div class="card-body">
                            <form method="GET" id="filterForm" action="{{ url('/professional_role_type') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-1">    
                                        ...
                                        <select class="formFilter change_title select2 form-select" name="title" id="select2-title">
                                            ...
                                            @if (isset($data['get_prof_roles']) && count($data['get_prof_roles']) > 0 )
                                                @foreach ($data['get_prof_roles'] as $key => $title_obj)
