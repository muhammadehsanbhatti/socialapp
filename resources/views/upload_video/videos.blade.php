    ...
    {{-- <button class="play-pause-btn">▶️</button> --}}
            ...
            <div class="video-actions">
                ...
                <div class="share-popup" id="sharePopup">
                    <button onclick="shareOnWhatsApp()"> <svg fill="#FFFFFF" height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        const videoPath = "{{ asset($video_detail->path) }}";
        ...
        function shareOnWhatsApp() {
            window.open(`https://api.whatsapp.com/send?text=${videoPath}`, '_blank');
        }

        function shareOnInstagram() {
            alert('Instagram sharing is not supported directly. Use the Instagram app to share.');
        }

        function shareOnFacebook() {
            window.open(`https://www.facebook.com/sharer/sharer.php?u=${videoPath}`, '_blank');
        }
