                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Filter Video</h4>
                        </div>

                        <div class="card-body">
                            <form method="GET" id="filterForm" action="{{ url('/upload_social_video') }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <select class="formFilter select2 form-select" name="orderBy_name" id="orderBy_name">
                                            ...
                                            <option value="upload_videos.id">ID</option>
                                            <option value="upload_videos.created_at">Created At</option>
                                            <option value="upload_videos.updated_at">Updated At</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mb-1">
