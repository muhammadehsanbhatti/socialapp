...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        Echo.channel('new-connection-request-count-channel')
            .listen('new-connection-request-count-event-129', (e) => {
                console.log('NewTrade listen');
                console.log(e);
                document.getElementById('latest_trade_user').innerText = e.trade;
            });
        // Echo.channel('chat-channel')
        //     .listen('.chat-event-2', (e) => {
        //         console.log('ChatMessageEvent listen');
        //         console.log(e);
        //     });
